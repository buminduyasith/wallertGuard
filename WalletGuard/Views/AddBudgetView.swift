    ...
    var body: some View {
        NavigationStack{
            List{
                ...
                Section("Title"){
                    TextField("title of the expense", text: $budgetVm.title)
                ...
                Section("Amount"){
                    HStack(){
                        ...
                        TextField("0.0", value: $budgetVm.amount, format: .currency(code: "LK"))
                            .foregroundColor(.black)
                ...
                Section("Year"){
                    ...
                    Picker("", selection: $budgetVm.year) {
                ...
                Section("Month"){
                    ...
                    Picker("Select a Month", selection: $budgetVm.selectedMonthIndex) {
            ...
            .toolbar{
                ...
                ToolbarItem(placement: .navigationBarTrailing){
                    Button("Save"){
                        Task{
                            do{
                                try await budgetVm.createBudget(budget:Budget(title: budgetVm.title, amount: budgetVm.amount, year: budgetVm.year, month: budgetVm.selectedMonthIndex ))
